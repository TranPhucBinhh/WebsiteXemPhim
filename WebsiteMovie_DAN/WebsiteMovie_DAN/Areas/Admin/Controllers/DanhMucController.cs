...
using WebsiteMovie_DAN.Areas.Admin.Strategy_Pattern;
...
namespace WebsiteMovie_DAN.Areas.Admin.Controllers
{
    public class DanhMucController : Controller
    {
        ...
        //WebsiteMovie_DAN.Entity.WebmoviedbEntities db = new Entity.WebmoviedbEntities();
        //// GET: Admin/DanhMuc
        ...
        //{
        //    Banner bn = data.Banners.SingleOrDefault(n => n.ID == id);
        //    if (bn == null)
        //    {
        //        Response.SubStatusCode = 404;
        //        return null;
        //    }
        //    data.Banners.DeleteOnSubmit(bn);
        //    data.SubmitChanges();
        ...
        {
            _strategy = new TheLoaiStrategy(); // Mặc định là thể loại
        }
        ...
        [HttpPost]
        public ActionResult ThemTheLoai(FormCollection collection, HttpPostedFileBase fileUpload = null)
        {
            _strategy = new TheLoaiStrategy();
        ...
        [HttpPost]
        public ActionResult SuaTheLoai(int id, FormCollection collection, HttpPostedFileBase fileUpload = null)
        {
            _strategy = new TheLoaiStrategy();
        ...
        [HttpPost]
        public ActionResult ThemNam(FormCollection collection, HttpPostedFileBase fileUpload = null)
        {
            _strategy = new NamPhatHanhStrategy();
            return _strategy.ThemMoi(collection, fileUpload);
        }
        ...
        [HttpPost]
        public ActionResult SuaNam(int id, FormCollection collection, HttpPostedFileBase fileUpload = null)
        {
            _strategy = new NamPhatHanhStrategy();
            return _strategy.ChinhSua(id, collection, fileUpload);
        }
